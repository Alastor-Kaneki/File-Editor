...
import com.alastorkaneki.fileeditor.ui.FileEditorApp
...
class MainActivity : ComponentActivity() {
    ...
    private val permissionLauncher = registerForActivityResult(
        ...
        viewModel.onPermissionResult(requiredPermissions().all { result[it] == true || hasPermission(it) })
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            FileEditorApp(
                viewModel = viewModel,
                onRequestPermission = ::requestAudioPermissions,
            )
        }

        viewModel.onPermissionResult(requiredPermissions().all(::hasPermission))
    }
